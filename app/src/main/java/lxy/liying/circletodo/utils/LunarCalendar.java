...
public class LunarCalendar {
    ...
    static SimpleDateFormat chineseDateFormat = new SimpleDateFormat("yyyy年MM月dd日", Locale.getDefault());
    ...
    final static String[] solarHoliday = new String[]{
            ...
            "1001 国庆", "1024 联合国日", "1112 孙中山诞辰纪念", "1220 澳门回归纪念", "1225 圣诞", "1226 毛泽东诞辰纪念"};
